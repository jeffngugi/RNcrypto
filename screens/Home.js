        ...
        return(
            <View style={{
                ...
                >
                    ...
                    >
                        <Text style={{marginLeft:SIZES.padding, color:COLORS.white,...FONTS.h2}}></Text>
                        <FlatList 
    ...
    const renderNotice = ()=>{
        return(
            ...
            >
                ...
                <Text style={{marginTop:SIZES.base, color:COLORS.white, ...FONTS.body4, lineHeight:18}}>It's very difficult to time invest, especially when the market is volatile. Learn how to use dollar cost averaging to your advantage.</Text>
                <TouchableOpacity
                    style={{marginTop:SIZES.base}}
                    onPress={()=> console.log('Load more')}
                >
                    <Text style={{textDecorationLine:'underline', color:COLORS.green, ...FONTS.h3}}>Load More</Text>
                </TouchableOpacity>
            </View>
        )
    }
